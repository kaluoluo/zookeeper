...
public class ZookeeperClient {
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        ZooKeeper client = new ZooKeeper("localhost:2181", 100000, new Watcher() {
            @Override
        ...
        //client.create("/luban3", "llb".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
...
//            @Override
//            public void process(WatchedEvent event) {
//                System.out.println("get绑定的watch"+event.getType());
//            }
//        }, null);
